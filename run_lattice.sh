...
PYTHONPATH=./ python src/recom_search/scripts/run_eval.py -model bfs_recom -dfs_expand -dataset fr-en -beam_size 4 -task mtn1 -min_len 5 -max_len -1 -ngram_suffix 4 -merge rcb -device cuda:1 -avg_score 0.904 -nexample 500000
#PYTHONPATH=./ python src/recom_search/scripts/run_eval.py -model bfs_recom -dfs_expand -dataset en-de -beam_size 4 -task mt1n -min_len 5 -max_len 80 -ngram_suffix 4 -merge rcb -device cuda:1 -avg_score 0.904 -nexample 10000
