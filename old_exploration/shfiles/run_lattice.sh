...
PYTHONPATH=./ python -u src/recom_search/scripts/run_eval.py -model bs -dfs_expand -dataset xsum -beam_size 50 -task sum -min_len 5 -max_len 80 -ngram_suffix 4 -merge none -device cuda:2 -avg_score 0.9 -nexample 500
PYTHONPATH=./ python -u src/recom_search/scripts/run_eval.py -model bs -dfs_expand -dataset xsum -beam_size 12 -task sum -min_len 5 -max_len 80 -ngram_suffix 4 -merge none -device cuda:2 -avg_score 0.9 -nexample 500
