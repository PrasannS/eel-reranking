...
#PYTHONPATH=./ python -u src/recom_search/scripts/run_eval.py -model bs -dfs_expand -dataset fr-en -beam_size 50 -task mtn1 -min_len 5 -max_len 80 -ngram_suffix 4 -merge none -device cuda:0 -avg_score 0.9 -nexample 100
