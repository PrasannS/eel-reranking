...
#PYTHONPATH=./ python -u src/recom_search/scripts/run_eval.py -model bs -dfs_expand -dataset fr-en -beam_size 50 -task mtn1 -min_len 5 -max_len 80 -ngram_suffix 4 -merge none -device cuda:3 -avg_score 0.9 -nexample 100

PYTHONPATH=./ python src/recom_search/scripts/run_eval.py -model bfs_recom -dfs_expand -dataset xsum -beam_size 4 -task sum -min_len 5 -max_len -1 -ngram_suffix 4 -merge rcb -device cuda:2 -avg_score 0.903 -nexample 10000
