...
def setup_model(task='sum', dataset='xsum', model_name='facebook/bart-large-xsum', device_name='cuda:3'):
...
def process_arg():
    ...
    parser.add_argument('-device', type=str, default='cuda:3', help='name of device, eg. cuda:3 or cpu')
